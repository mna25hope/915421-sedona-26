...
- Студент: [Надежда Михайлова](https://up.htmlacademy.ru/htmlcss/26/user/915421).
- Наставник: `KEKS`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/915421-sedona-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
